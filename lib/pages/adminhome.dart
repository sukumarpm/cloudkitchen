...
//     final DateFormat formatter = DateFormat('yyyy-MM-dd');
//     final String formatted = formatter.format(now);
//     await FirebaseFirestore.instance.collection("orders").count().get().then(
//           (res) => setState(() {
...
//         for (var docSnapshot in querySnapshot.docs) {
//           final str = docSnapshot.data();
//           MyOrders orderh = MyOrders.fromJson(str);
...
//                                               ),
//                                               elevation: 5,
//                                               shadowColor: categoryImage[index]
//                                                   ['color'],
                          ...
                          Row(
                            children: [
                              ...
                              GestureDetector(
                                ...
                                onTap: () {
                                  _navigationService.pushNamed("/adminprofile");
                                },
                              ),
                            ],
                          ),
                          ...
                          ? Column(
                              children: [
                                ...
                                SizedBox(
                                  height: _deviceHeight * .7,
                                  // height: cartshow
                                  //     ? (listordercurrent[Index].items!.length +
                                  //             1) *
                                  //         90
                                  //     : 120,
                                  child: ToggleList(
